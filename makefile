...
SRCS=main.c state.c screen_transition.c assets.c audio.c ppp_logo.c title_screen.c team_select.c gameplay.c AI.c objects/player.c input.c pause.c debug.c util.c lighting.c physics.c math.c font.c ColorHelpers.c palettetools.c sprites.c bg_def/bg26.c 
