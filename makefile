...
SRCS=main.c backup.c state.c screen_transition.c assets.c audio.c ppp_logo.c title_screen.c team_select.c gameplay.c AI.c objects/player.c input.c pause.c debug.c util.c physics.c math.c font.c ColorHelpers.c palettetools.c sprites.c bg_def/nbg0.c 
